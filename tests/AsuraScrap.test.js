...
describe("AsuraScrap Class", () => {
    ...
    beforeEach(async () => {
        asuraScrap = createSiteScrapClass("Asura Toon", 0);
    ...
    test("test Asura site Icon", async () => {
    ...
    test("test Asura check get manga links", async () => {
        await basicActionBrowser.accessPage(asuraScrap.mainUrl)
        ...
        expect(allMangaSources.length).toBe(50);
    });

    test("test Asura check pagination", async () => {
        await basicActionBrowser.accessPage(asuraScrap.mainUrl)
    ...
    test("test Asura check manga", async () => {
        await basicActionBrowser.accessPage(asuraScrap.mainUrl);
        var allMangaSources = await headLessBrowser.getDataEvaluateLoop(asuraScrap.mangaInfo[0], asuraScrap.mangaInfo[1]);
    ...
    test("test Asura check manga info", async () => {
